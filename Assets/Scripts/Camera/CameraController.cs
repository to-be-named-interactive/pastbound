...
public class CameraController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        //Calculating cameras height and width from OrthographicSize.(We need the height to get the width)
        virtualCameraHeight = 2f * OrthographicSize;
        virtualCameraWidth = virtualCameraHeight * virtualCamera.m_Lens.Aspect;

        //Sometimes virtualCameraWidth would go 20f for a few times and 35.5555556f for most times, which made some twitching
