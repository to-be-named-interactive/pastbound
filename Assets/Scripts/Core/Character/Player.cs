...
public class Player : MonoBehaviour {
	...
	[SerializeField] private float nextAttackTimeWindow;
	...
	[HideInInspector]public bool IsJumping { get; private set; }//Bool when is player jumping
	[HideInInspector] public float LastPressedJumpTime { get; private set; }//Time when the jump button was last presed
	[HideInInspector] public float LastPressedRollTime { get; private set; }
	...
	//Timers
	[HideInInspector] public float LastOnGroundTime { get; private set; }
	[HideInInspector] public float JustLandedTime { get; private set; }
	...
	[HideInInspector] private bool freezePlayer;
	...
	[HideInInspector] public AnimationFunctions animatorFunctions;
	...
	[HideInInspector] public GameObject nextScreenBox;
	GameObject sc;
    ...
    //Fliping character grapihc when moving on the opposite direction 
    ...
    public GameObject[] ScreenBoxDetection()
    {
		...
		//Debug.DrawRay(raycastOrigin, inputHandler.inputDirection * SC_RaycastMaxDistance, Color.red);
			...
			if (hit)
			{
				...
				//Begining setup where both are null. So the very first screenbox will have this only
